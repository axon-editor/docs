...
<Screenshot
  ...
  caption="Open the folder that owns the project metadata, or return to a recent workspace, so the editor, terminal, Git, and language servers share the same root."
/>
