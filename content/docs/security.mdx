...
<Screenshot
  ...
  alt="Axon asking whether to trust a newly opened workspace"
  caption="Workspace trust keeps project-aware execution behind an explicit decision when a folder is opened."
/>
...
<Screenshot
  src="/media/screenshots/captures/axon-capture-50.png"
  alt="Axon confirmation dialog for marking an active workspace untrusted"
  caption="Revoking trust explains which project-aware execution surfaces will stop before the workspace capability changes."
/>
