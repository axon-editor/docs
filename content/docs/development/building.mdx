...
Development uses an authenticated Core service on `127.0.0.1:17777`. Packaged launches choose a private random port unless `AXON_CORE_PORT` is explicitly set.
