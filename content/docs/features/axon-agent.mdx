...
<Screenshot
  src="/media/screenshots/axon-latest-16.png"
  alt="Ask Axon panel open beside the active code editor"
  caption="Ask Axon opens beside the active file with project problems and workspace context available to the conversation."
/>
...
<Screenshot
  ...
  alt="Axon Agent interactive session running in the integrated terminal"
  caption="The terminal agent shows the attached workspace, session identity, selected model, and local commands before the conversation begins."
/>
