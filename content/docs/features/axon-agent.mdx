...
<Screenshot
  ...
  alt="Axon integrated terminal ready for a project-aware command"
  caption="Terminal-native Agent commands run inside the same workspace-owned shell surface as normal project commands."
/>
...
<Screenshot
  ...
  alt="Axon Problems view showing diagnostics available to workspace-safe fixes"
  caption="Workspace-safe fixes begin from structured Problems entries with exact files, locations, sources, and diagnostic codes."
/>
